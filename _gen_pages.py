...
PAGES = {
    "for-content-creators.html": {
        ...
        "sub": "Bloggers, newsletter writers, and YouTube scriptwriters — you publish constantly, and your voice is the product. We test AI copywriting tools for content creators on real publishing work. These are the tools and methods we actually use to scale our output and that we've found genuinely useful — use them as a starting point.",
        "intro": "",
        "tools": [],
        "verdict": "",
    },
    "for-self-media.html": {
        ...
        "title": "Best AI Copywriting Tools for Social-Media Creators | CopyTools",
        "desc": "Best AI copywriting tools for social-media creators, tested on Xiaohongshu notes, Douyin scripts, and TikTok captions. One test: would a real person stop scrolling?",
        "h1": "Best AI Copywriting Tools for Social-Media Creators (Xiaohongshu, Douyin, TikTok, WeChat)",
        "sub": "Hooks, captions, and scripts that don't read like a bot wrote them. We tested the tools on the exact formats social-media creators post every day.",
    ...
    "for-office-workers.html": {
        ...
        "sub": "We test AI copywriting tools for office workers on the work you actually do — weekly reports, emails, and slides. Had a report rejected by your boss, or slides that just looked off? Don't worry: we test every tool for you and show what each one is really like to use — how to get started, what it costs, how it compares to the others, which tools it works well with, and who it's best for. So you never have to download and try them all yourself.",
        "intro": "",
        "tools": [],
        "verdict": "",
    },
    "for-beginners.html": {
        ...
        "intro": "Most 'best AI writer' lists assume you already know the jargon. You don't. We picked tools a total beginner can open and get something usable from in 5 minutes, then ranked them by learning curve and price.",
        "tools": [
