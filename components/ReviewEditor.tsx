...
export default function ReviewEditor() {
  ...
  function doExportWord() {
    ...
    if (d.kind === "narrative") {
      ...
      downloadWord(currentText(), name || "performance-scorecard");
    }
  }
        ...
        {doc && (
          <>
            ...
            <p className="mt-md font-body-sm text-body-sm text-text-muted">
              ...
              your history{user ? "" : " (sign in to keep it across devices)"}.
              PDF and Word exports include the {WATERMARK_LINE.replace("Generated by ", "")} watermark.
            </p>
          </>
        )}
      </div>
